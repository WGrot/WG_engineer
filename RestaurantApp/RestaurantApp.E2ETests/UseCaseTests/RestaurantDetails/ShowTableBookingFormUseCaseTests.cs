...
[TestFixture]
public class ShowTableBookingFormUseCaseTests : PlaywrightTestBase
{
    ...
    [Test]
    public async Task TableBookingTab_OnDisplay_ShowsBookingForm()
    {
        // Arrange
        ...
        // Assert
        await _restaurantDetailsPage.TableBooking.AssertBookingFormVisibleAsync();
    }
    
    [Test]
    public async Task TableBookingTab_OnDisplay_ShowsCheckAvailabilityButton()
    {
        // Arrange
        await _restaurantDetailsPage.GotoAsync(_testRestaurantId);
        await _restaurantDetailsPage.SwitchToTableBookingTabAsync();
        ...
        // Act
        var isVisible = await _restaurantDetailsPage.TableBooking.IsCheckAvailabilityButtonVisibleAsync();

        // Assert
        Assert.That(isVisible, Is.True, "Check Availability button should be visible");
    }
