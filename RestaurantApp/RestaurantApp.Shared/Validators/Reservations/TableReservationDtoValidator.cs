...
namespace RestaurantApp.Shared.Validators.Reservations;

public class TableReservationDtoValidator : AbstractValidator<TableReservationDto>
{
    public TableReservationDtoValidator()
    {
